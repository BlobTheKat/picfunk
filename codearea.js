{
	...
	sheet.insertRule('textarea{z-index:1;padding:0;padding-left:max(1ch,var(--min-gutter) * 1ch);margin:0;inset:0;border:none;outline:none;background:none;font:inherit;color:#0000;resize:none;caret-color:#999;white-space:pre-wrap;tab-size:inherit;box-sizing:border-box;-webkit-tap-highlight-color:#0000;text-size-adjust: none;-webkit-text-size-adjust: none;overflow-wrap:break-word !important;word-wrap:break-word !important;touch-action:pan-y;overflow-wrap:inherit;overflow:clip;grid-area:1/1}', 0)
